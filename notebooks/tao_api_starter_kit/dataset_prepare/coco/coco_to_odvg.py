# Adapted from Open-GroundingDino (https://github.com/longzw1997/Open-GroundingDino)
#   tools/coco2odvg.py
# Copyright (c) 2023 longzw1997. Licensed under the MIT License.
# Permission notice from the upstream MIT License is retained in this derivative work.
#
